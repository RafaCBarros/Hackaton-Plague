<template>
  <div id="dashboard">
    <!-- Classe para garantir alinhamento

      Uso de h1 para título de página e h2 para subtítulo,
          garantindo formatação padrão através do projeto
      
      Q-card para garantia de uma div para diminuir o uso de CSS específico
      -->
